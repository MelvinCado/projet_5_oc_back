 ...
 */
final class Version20200518165728 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE amount DROP FOREIGN KEY FK_8EA17042A76ED395');
        $this->addSql('ALTER TABLE amount ADD CONSTRAINT FK_8EA17042A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
}
